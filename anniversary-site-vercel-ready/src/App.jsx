...
export default function App() {
 ...
 <Card className='bg-zinc-900/80 rounded-2xl'><CardContent className='p-6 space-y-3'><h2 className='text-2xl font-semibold'>kasihtau aku jwbnnya apa karna aku blm paham gmn send notif klo km pencet pilihannya hehe</h2></CardContent></Card>
 </div></div></div>
}
