...
export default function App() {
 ...
 <p className='text-zinc-300 text-lg'>Hiiiiii sayanggkuuuuuu... makasih ya udah selalu sabar sama aku</p>
 ...
 {!loveAccepted ? <>
 <p className='text-zinc-400 text-sm mb-5'>Jawab yang jujur ya 😚</p>
 <div className='relative h-28 flex items-center justify-center gap-4'>
 <Button className='rounded-2xl px-6 py-3' onClick={()=>setLoveAccepted(true)}>Sayang 💖</Button>
 <div style={{transform:`translate(${noPos.x}px,${noPos.y}px)`}} className='transition-all duration-300'>
 <Button className='rounded-2xl px-6 py-3 bg-zinc-800 text-zinc-100 hover:bg-zinc-700' onMouseEnter={moveNoButton} onClick={moveNoButton}>Tidak 🙈</Button>
 ...
 <Card className='bg-zinc-900/80 rounded-2xl'><CardContent className='p-6 space-y-3'><h2 className='text-2xl font-semibold'>sayaangkuuu</h2><p className='text-zinc-300'>Thank you for choosing us, even on the hard days.</p></CardContent></Card>
